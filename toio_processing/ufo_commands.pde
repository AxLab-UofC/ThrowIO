...
//boolean findForwardLocation(int otherToioNumber) {
...
//  //otherToioX, otherToioY will be other toio's location
//  float otherToioX = 0.0;
//  float otherToioY = 0.0;

//  //otherToioX, otherToioY will be other toio's location
//  float pushingToioX = 0.0;
//  float pushingToioY = 0.0;

//  if (otherToioNumber == 0) {
//    otherToioX = cubes[0].x;
//    otherToioY = cubes[0].y;

//    pushingToioX = cubes[1].x;
//    pushingToioY = cubes[1].y;
    
//    //puhsing toio's rotation degree
//    theta = cubes[1].deg;
//  } else {
//    otherToioX = cubes[1].x;
//    otherToioY = cubes[1].y;

//    pushingToioX = cubes[0].x;
//    pushingToioY = cubes[0].y;
    
//    //puhsing toio's rotation degree
//    theta = cubes[0].deg;
//  }
  
//  if ((pushingToioX - otherToioX)> 0 & (pushingToioY - otherToioY) < 0) { //we already convert quadrant coordinates to toio mat coordinates

//    println("other toio in quadrant 1");
//    x = pushingToioX+global_bitMoreThanRadius*cos(theta);
//    y = pushingToioY-global_bitMoreThanRadius*sin(theta);
//  } else if ((pushingToioX - otherToioX) < 0 & (pushingToioY - otherToioY) < 0) {

//    println("other toio in quadrant 2");
//    x = pushingToioX-global_bitMoreThanRadius*cos(theta);
//    y = pushingToioY-global_bitMoreThanRadius*sin(theta);
//  } else if ((pushingToioX - otherToioX) < 0 & (pushingToioY - otherToioY) > 0) {

//    println("other toio in quadrant 3");
//    x = pushingToioX-global_bitMoreThanRadius*cos(theta);
//    y = pushingToioY+global_bitMoreThanRadius*sin(theta);
//  } else if ((pushingToioX - otherToioX) > 0 & (pushingToioY - otherToioY) > 0) {

//    println("other toio in quadrant 4");
...
//    if ((pushingToioX - otherToioX) == 0 & (pushingToioY - otherToioY) > 0) {

//      println("other toio in between 3 and 4 quadrants");
//      x = pushingToioX+global_bitMoreThanRadius*sin(theta);
//      y = pushingToioY+global_bitMoreThanRadius*cos(theta);
//    } else if ((pushingToioX - otherToioX) > 0 & (pushingToioY - otherToioY) == 0) {

//      println("other toio in between 1 and 4 quadrants");
//      x = pushingToioX+global_bitMoreThanRadius*cos(theta);
//      y = pushingToioY-global_bitMoreThanRadius*sin(theta);
//    } else if ((pushingToioX - otherToioX) == 0 & (pushingToioY - otherToioY) < 0) {

//      println("other toio in between 1 and 2 quadrants");
//      x = pushingToioX+global_bitMoreThanRadius*sin(theta);
//      y = pushingToioY-global_bitMoreThanRadius*cos(theta);
//    } else if ((pushingToioX - otherToioX) < 0 & (pushingToioY - otherToioY) == 0) {

//      println("other toio in between 2 and 3 quadrants");
//      x = pushingToioX-global_bitMoreThanRadius*cos(theta);
//      y = pushingToioY+-global_bitMoreThanRadius*sin(theta);
//    } else {
...
//  //  global_finalx = cubes[1].x;
//  //  global_finaly = cubes[1].y;
//  //} else {
//  //  global_xprime = x;
//  //  global_yprime = y;
...
//  //println("x: ", x);
//  //println("y: ", y);
//  //println("pushingToioX: ", pushingToioX);
//  //println("pushingToioY: ", pushingToioY);
//  //println("global_backoutx0: ", global_backoutx0);
//  //println("global_backouty0: ", global_backouty0);
//  //println("global_backoutx1: ", global_backoutx1);
//  //println("global_backouty1: ", global_backouty1);
